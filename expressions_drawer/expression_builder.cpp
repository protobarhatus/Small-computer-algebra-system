...
ExpressionPtr ExpressionBuilder::funcName(const QString &name, WrapperFlags &flags, bool needBrackets)
{
  ...
  if (name_to_upper == QLatin1String("SQRT")) {
    ExpressionPtr expr = stringExpression(Wrapper::Expression);
    return new RootExpression(expr);
  }
  else if (name_to_upper == QLatin1String("SQR")) {
    flags.setFlag(WrapperFlag::Powered);
    return makePower(stringExpression(Wrapper::Power), new NumberExpression(2.0));
  }
  else if (name_to_upper == QLatin1String("LOG")) {
    return functionLOG(name, needBrackets);
  }
  else if (name_to_upper == QLatin1String("ABS")) {
    return stringExpression(Wrapper::Abs);
  }
  else if (name_to_upper == QLatin1String("POW")) {
    return functionPOW(flags);
  }
  else if (name_to_upper == QLatin1String("ROOT")) {
    return functionROOT();
  }
  else if (name_to_upper == QLatin1String("IND")) {
    return functionIND();
  }
  else if (name_to_upper == QLatin1String("LIM")) {
    return functionLIM(flags, needBrackets);
  }
  else if (name_to_upper == QLatin1String("FUNC")) {
    return functionFUNC(needBrackets);
  }
  else if (name_to_upper == QLatin1String("FRAME")) {
    return functionFRAME();
  }
  else if (name_to_upper == QLatin1String("SPACE")) {
    return functionSPACE();
  }
  else if (name_to_upper == QLatin1String("DIFF")) {
    return functionDIFF();
  }
  else if (name_to_upper == QLatin1String("PDIFF")) {
    return functionPDIFF();
  }
  else if (name_to_upper == QLatin1String("DIFFN")) {
    return functionDIFFN();
  }
  else if (name_to_upper == QLatin1String("PDIFFN")) {
    return functionPDIFFN();
  }
  else if (name_to_upper == QLatin1String("DIFFR")) {
    return functionDIFFR();
  }
  else if (name_to_upper == QLatin1String("PDIFFR")) {
    return functionPDIFFR();
  }
  else if (name_to_upper == QLatin1String("DIFFRF")) {
    return functionDIFFRF();
  }
  else if (name_to_upper == QLatin1String("PDIFFRF")) {
    return functionPDIFFRF();
  }
  else if (name_to_upper == QLatin1String("STRING")) {
    return functionSTRING();
  }
  else if (name_to_upper == QLatin1String("STROKES")) {
    return functionSTROKES(flags);
  }
  else if (name_to_upper == QLatin1String("FACT")) {
    return functionFACT(flags);
  }
  else if (name_to_upper == QLatin1String("AT")) {
    return functionAT();
  }
  else if (name_to_upper == QLatin1String("LINE")) {
    return functionCAPTION(CapExpression::CapStyle::Line);
  }
  else if (name_to_upper == QLatin1String("VECT")) {
    return functionCAPTION(CapExpression::CapStyle::Vector);
  }
  else if (name_to_upper == QLatin1String("CAP")) {
    return functionCAPTION(CapExpression::CapStyle::Cap);
  }
  else if (name_to_upper == QLatin1String("TILDA")) {
    return functionCAPTION(CapExpression::CapStyle::Tilde);
  }
  else if (name_to_upper == QLatin1String("POINTS")) {
    return functionPOINTS();
  }
  else if (name_to_upper == QLatin1String("STANDL")) {
    return functionSTAND(Qt::AlignLeft);
  }
  else if (name_to_upper == QLatin1String("STANDC")) {
    return functionSTAND(Qt::AlignHCenter);
  }
  else if (name_to_upper == QLatin1String("STANDR")) {
    return functionSTAND(Qt::AlignRight);
  }
  else if (name_to_upper == QLatin1String("MATRIX")) {
    return functionMATRIX();
  }
  else if (name_to_upper == QLatin1String("SUMMA")) {
    return functionGroupOp(GroupType::Summa, needBrackets);
  }
  else if (name_to_upper == QLatin1String("PROD")) {
    return functionGroupOp(GroupType::Product, needBrackets);
  }
  else if (name_to_upper == QLatin1String("CIRC")) {
    return functionGroupOp(GroupType::Circulation, needBrackets);
  }
  else if (name_to_upper == QLatin1String("INT")) {
    return functionGroupOp(GroupType::Integral, needBrackets);
  }
  else if (name_to_upper == QLatin1String("INTM")) {
    return functionGroupOp(GroupType::IntegralM, needBrackets);
  }
  else if (name_to_upper == QLatin1String("CASE")) {
    return functionCASE();
  }
  else if (name_to_upper == QLatin1String("COMMA")) {
    return functionCOMMA();
  }
  else if (name_to_upper == QLatin1String("BRACKETS")) {
    return functionBRACKETS();
  }
  else if (name_to_upper == QLatin1String("SYSTEM")) {
    return functionSYSTEM();
  }
  else if (name_to_upper == QLatin1String("NUM")) {
    return functionNUM();
  }
  else if (name_to_upper == QLatin1String("SYMBOL")) {
    return functionSYMBOL();
  }
  else if (name_to_upper == QLatin1String("ANGLE")) {
...
double ExpressionBuilder::getDouble(const QString &str, int from, int &next_pos)
{
  ...
  bool ok;
  const double result = str.mid(from, next_pos - from).toDouble(&ok);
  if ( !ok ) {
    next_pos = -1;
    m_last_error = Error(ErrorCode::ConvertToNumber,
